        ...
        <div class="plantasPlanta form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('family_id', ['label' => 'Familia', 'options' => $plantFamilies, 'empty' => true]);
                    echo $this->Form->control('type_id', ['label' => 'Tipo', 'options' => $plantTypes, 'empty' => true]);
                ?>
            </fieldset>
